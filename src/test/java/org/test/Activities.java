...
public class Activities extends BaseClass {
	...
	public void getActivities() {
		GET(ACTIVITIES, 200, "[0].title", "Activity 1");
	}
	...
	public void postActivities() throws IOException {
		POST("jsonPathOfNewActivities", ACTIVITIES, 200, "title", "New Activity");
	}
	...
	public void getActivitiesById() {
		GET(ACTIVITIES_BY_ID, 200, "title", "Activity 1");
	}
	...
	public void putActivitiesById() throws IOException {
		PUT("jsonPathOfUpdateActivities", ACTIVITIES_BY_ID, 200, "title", "Update Activity");
	}
